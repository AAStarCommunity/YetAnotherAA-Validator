...
`applyFraudProofVerifier()` is **permissionless** — any funded key, no
arguments, no owner involvement. Run `deploy/apply-verifier-rotation.mjs` on or
after 2026-09-04T05:36:24Z; it refuses to act early and reads the result back
