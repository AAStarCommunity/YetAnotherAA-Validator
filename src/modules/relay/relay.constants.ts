...
/** Sepolia Path-A canonical-bound stack; buyHelper = audit-fix redeploy 2026-06-24
 *  (MushroomDAO/launch#27 — receiveWithAuthorization, whitelists the 3 DVT operators). Override via env in prod. */
